        ...
        if (first != null) {
            ...
            try {
                for (i in parameters.indices) {
                    ...
                    objects[i] = when (parameter.type) {
                        Int::class.javaPrimitiveType, Int::class.javaObjectType -> option.asLong.toInt()
                        Long::class.javaPrimitiveType, Long::class.javaObjectType -> option.asLong
                        Boolean::class.javaPrimitiveType, Boolean::class.javaObjectType -> option.asBoolean
                        Double::class.javaPrimitiveType, Double::class.javaObjectType -> option.asDouble
