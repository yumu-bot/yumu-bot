...
public class PPMinusException extends TipsException {
    public enum Type {
        PM_Me_TokenExpired("您的令牌已过期，请重新授权。(!ymbind)"),//查询自己_玩家未绑定
        PM_Me_PlayTimeTooShort("你在 %s 模式上的游戏时长太短了，快去多玩几局吧！"),//查询自己_玩家号太新
        PM_Me_NotFound("找不到你所绑定的玩家。"), //获取玩家失败
        PM_Me_FetchFailed("获取你的 PP- 失败，有可能是你输错了玩家名，或是指定了错误的模式。"), //获取PPM失败
        ...
        PM_Player_PlayTimeTooShort("他在 %s 模式上的游戏时长太短了，快去催他多玩几局吧！"),//查询他人_玩家号太新
