...
open class NoSuchElementException(message: String?): TipsRuntimeException(message) {
    ...
    class Leaderboard:
        NoSuchElementException("这张谱面没有榜。")
