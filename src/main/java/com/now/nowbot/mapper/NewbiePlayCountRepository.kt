...
interface NewbiePlayCountRepository : JpaRepository<NewbiePlayCount, Long> {
    ...
    @Query("""
            ...
            select rank from sr_rank where uid = :uid
            """, nativeQuery = true)
    fun getPPAddRank(uid: Long, date: LocalDate): Int?
