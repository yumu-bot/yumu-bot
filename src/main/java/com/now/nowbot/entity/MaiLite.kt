...
// CREATE INDEX mai_title_trgm ON maimai_song USING gin (upper(query_text) gin_trgm_ops);
class MaiSongLite(
    @Id
    var songID: Int? = null,
...
// CREATE INDEX chu_title_trgm ON chunithm_song USING gin (upper(query_text) gin_trgm_ops);
class ChuSongLite(
    @Id
    @Column(columnDefinition = "integer")
    var songID: Int,
