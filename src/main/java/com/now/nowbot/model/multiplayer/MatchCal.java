...
public class MatchCal {
     ...
     * @return 对局 Round
     */
    public List<MatchRound> getMatchRound(boolean rematch) {
        var result = events.filter(matchRound -> !CollectionUtils.isEmpty(matchRound.getScoreInfoList()));
        if (rematch) {
