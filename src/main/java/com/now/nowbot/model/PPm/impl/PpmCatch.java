    ...
    public PpmCatch(OsuUser user, List<BpInfo> bps){
        ...
        for (int i = 0; i < bps.size(); i++) {
            ...
            //3.1 准度fACC formulaic accuracy 0-1 facc
            {
                ...
                value1 = (acc) < 0.6 ? 0 : Math.pow((acc - 0.6) * 2.5D, 5);
                value1 = check(value1, 0, 1);
            }
            //3.2 潜力PTT potential 0-1 ptt
            ...
            //Total
            value7 = value1*0.2 + value2*0.1 + value5*0.1 + value6*0.2 + value4*0.2 + value3*0.2;
            //san
            //TODO ppmcatch san没写好uwu
