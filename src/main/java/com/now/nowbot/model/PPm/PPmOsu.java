...
public class PPmOsu implements PPmObject {
    float ppv0=0;
    float ppv45=0;
    float ppv90=0;
    float accv0=0;
     ...
     * @param prbp bp列表
     */
    public PPmOsu(JSONObject prd, JSONArray prbp) {
    ...
    PPmOsu(OsuUser user, List<BpInfo> bps){
        ...
        ttl = facc * 0.2 + ptt * 0.1 + sta * 0.2 + stb * 0.2 + eng * 0.1 + sth * 0.2;
